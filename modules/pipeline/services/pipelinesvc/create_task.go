...
func (s *PipelineSvc) makeNormalPipelineTask(p *spec.Pipeline, ps *spec.PipelineStage, action *pipelineyml.Action, passedDataWhenCreate *task_extensions.PassedDataWhenCreate) *spec.PipelineTask {
